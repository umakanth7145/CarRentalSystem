			...
			<table  style="width:82%;margin:auto;">
				<tr>
					<td>
						...
						<h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">wheelzonrent offers to make it easy for clients to get the right car at
							 the right price at the right time. If you are looking for car rental service in Hyderabad/India or minibusses hire 
							 services, then our company is the right option for you. Get the best deal on booking of luxury car and coaches in Hyderabad.</h3>
					...
					<td>
						...
						<h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">Wheelzonrent is emerging car rental company in Hyderabad/india . We have been known in industry 
				...
				<tr>
					...
					<td>
						...
						<h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">Wheelzonrent is providing One Way Drop Services From Hyderabad / NCR. We offer 
							to make it easy for clients to get the right car at the right price at the right time. If you are looking for 
							car rental service in Hyderabad/India, we are the right choice for you.</h3>
        ...
        <footer>
			<table style="height:10%;">
				...
				<tr bgcolor="#252525">
					...
					<td class="widget">
						<p class="text1">Address: Hyderabad,India<br>
						<img src="images/phone.png">&emsp;+91-7305010188<br>
						<img src="images/message.png">&emsp;renat123@gmail.com</p>
					</td>
				</tr>
				<tr bgcolor="black">
